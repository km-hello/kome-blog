  ...
  <div class="min-h-screen flex flex-col">
    ...
    <div class="max-w-6xl mx-auto px-4 md:px-6 py-8 w-full">
      ...
      <template v-else-if="post">
        ...
        <!-- 文章元信息头部（padding 响应式 p-6 → md:p-8） -->
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <!-- 文章正文（padding 响应式 p-4 → sm:p-6 → md:p-8 → lg:p-10） -->
    ...
    <template v-if="toc.length > 0">
      ...
      >
        ...
        >
          ...
          <!-- 目录列表 -->
          <ul class="overflow-y-auto overscroll-contain px-5 py-3 space-y-0 scrollbar-thin"
